...
NAME = 'CathayRepair'
ENTRY = 'gui.py'
VERSION_SRC = ['repair.py']
EXTRA = ['--collect-all', 'tkinterdnd2']
REPO = 'https://github.com/zzhjim02/CathayRepair'
...
- `CathayRepair.exe` —— 单文件版，约 %.0f MB，双击即用
- `runtime\\`（约 79 MB，自带 Python）+ `修复.bat`
